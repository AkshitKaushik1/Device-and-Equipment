...
public class AddPipelinePage extends BasePage{
	...
	Actions a = new Actions(driver);
	 ...
	 /**
	   ...
	   By productTypeGas			=By.xpath("//*[@id=\"ion-overlay-1\"]/div[2]/div[2]/ion-select-popover/ion-list/ion-radio-group/ion-item[1]/ion-radio");
	   By comodityType				=By.xpath("//*[@id=\"comodityType\"]");
	   By naturalGas				=By.xpath("//*[@id=\"ion-overlay-2\"]/div[2]/div[2]/ion-select-popover/ion-list/ion-radio-group/ion-item[1]/ion-radio");
	   ...
	   //By gradeValue				=By.xpath("//*[@id=\"gradeValue\"]");
	  // By grade						=By.xpath("//*[@id=\"ion-overlay-5\"]/div[2]/div[2]/ion-select-popover/ion-list/ion-radio-group/ion-item[1]");
	   ...
	   public PipelinePage createPipeline() throws InterruptedException {
	       ...
	       try {
	           ...
	           // js.executeScript("window.scrollTo(0,document.body.scrollHeight","");
	            ...
	            WebElement scroll = driver.findElement(By.xpath("//*[@id=\"cathodicProtectionValue\"]")); 
	            System.out.println("lable is detected");
	            ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", scroll);
	            //scroll.sendKeys(Keys.PAGE_DOWN);
	            System.out.println("scroll is executed");
